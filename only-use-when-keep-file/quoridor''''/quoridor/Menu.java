...
public class Menu {
    ...
    public void start() {
        ...
        while (true) {
            System.out.println("enter 1 for Quoridor"
                    + "\nenter 2 for exit game");
            ArrayList<String> as = new ArrayList<>(Arrays.asList("1", "2"));
    ...
    public void player_and_pieces_set_up() {
        ...
        Generalboardgame generalBoardGame = new Generalboardgame();
...
//        int c_color1 = generalBoardGame.CheckSetUp(-1, 2);
        int c_color1 = 1;
        ...
        while (!piece_different) {
            ...
            if (!p1.get_o_p().equals(p2.get_o_p())) {
                ...
                int c_color2 = 1;
//                int c_color2 = generalBoardGame.CheckSetUp(-1, 2);
