                ...
                while (!set_another_p){
                    ...
                    if (c_p_i%2==0){//shu zhe de//abs of rows =2
                        if((c_another_p%2==0)
                            ...
                            Block c=new Block();
                            c.setBlock("|");
                            q_board.set_p(((c_p - 1) / this.total_M+((c_another_p - 1) / this.total_M))/2,(c_p - 1) % this.total_M,c);
                            System.out.println(q_board);
                            Pieces p=new Pieces();
                            p.setPtest("|");
                        ...
                        if((c_another_p%2==0)
                            ...
                            Block c=new Block();
                            c.setBlock("--");
                            q_board.set_p((c_p - 1) / this.total_M,((c_p - 1) % this.total_M+((c_another_p - 1) % this.total_M))/2,c);
                            System.out.println(q_board);
                            Pieces p=new Pieces();
                            p.setPtest("--");
                            q_board.set_p(((c_another_p - 1) / this.total_M) ,((c_another_p - 1) % this.total_M),p);
